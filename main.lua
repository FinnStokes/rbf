...
function love.load()
   ...
   r1.outputs[1] = weapons.laser({robot=r1,target=r2,damage=1,position=5,label="Laser"})
   r1.outputs[2] = weapons.rocket({robot=r1,target=r2,damage=6,position=10,label="Rocket"})
   r1.outputs[3] = weapons.claw({robot=r1,target=r2,damage=1.5,position=15,label="Claw"})
   r1.outputs[4] = robot.walk({robot=r1,vel=1.2,position=22,label="Forwards"})
   r1.outputs[5] = robot.walk({robot=r1,vel=-1.2,position=27,label="Backwards"})
   ...
   r2.outputs[1] = weapons.laser({robot=r2,target=r1,damage=1,position=5,label="Laser"})
   r2.outputs[2] = weapons.rocket({robot=r2,target=r1,damage=6,position=10,label="Rocket"})
   r2.outputs[3] = weapons.claw({robot=r2,target=r1,damage=1.5,position=15,label="Claw"})
   r2.outputs[4] = robot.walk({robot=r2,vel=1.2,position=22,label="Forwards"})
   r2.outputs[5] = robot.walk({robot=r2,vel=-1.2,position=27,label="Backwards"})
